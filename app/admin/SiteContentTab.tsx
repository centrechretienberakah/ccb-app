...
const PAGES: { key: string; label: string; icon: string; hint?: string }[] = [
  ...
  { key: "dons",        label: "Faire un don", icon: "💝", hint: "Titre + intro de la page Dons" },
  { key: "dons-paiement", label: "Dons · Moyens de paiement", icon: "💳", hint: "Numéros & coordonnées. Champ « Contenu » — une ligne par moyen : region | emoji | titre | détail | numéro | type. (region = CM/EU/INTL/CD · type = instant/manual/contact)" },
