...
const VIDEOS = [
  ...
  { id: "5", date: "2026-05-09", title: "Réconciliés avec Dieu", scripture: "Romains 5:1", theme: "Réconciliation", youtubeId: "", tiktokUrl: "", content: "Étant donc justifiés par la foi, nous avons la pais avons la paix avec Dieu par notre Seigneur Jésus-Christ. Le péché creusait un fossé — la croix l’a comblé. Tu peux t’approcher de Dieu aujourd’hui.", emoji: "🕊️" },
];
