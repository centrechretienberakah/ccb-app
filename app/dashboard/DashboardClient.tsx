...
const QUICK_ACTIONS = [
  ...
  { emoji: "🙏", label: "Prions ensemble", sub: "Intercession & demandes", href: "/community/prions-ensemble", gradient: "linear-gradient(145deg, #4c0519 0%, #9f1239 55%, #fb7185 100%)", glow: "rgba(251,113,133,0.35)" },
