...
import {
  ...
  IconGraduationCap, IconBookmark, IconRadio, IconGift,
...
const QUICK_ACTIONS = [
  {
    ...
    href: "/devotion",
    gradient: "linear-gradient(145deg, #92400e 0%, #d97706 55%, #fbbf24 100%)",
  ...
  },
  {
    ...
    emoji: "📖",
    label: "Bible",
    sub: "Lire les Écritures",
    href: "/bible",
    gradient: "linear-gradient(145deg, #1e3a5f 0%, #1e40af 55%, #3b82f6 100%)",
  ...
  },
  {
    ...
    emoji: "🙏",
    label: "Prière",
    sub: "Intercession & demandes",
    href: "/prayer",
    gradient: "linear-gradient(145deg, #4c0519 0%, #9f1239 55%, #fb7185 100%)",
  ...
  },
  {
    ...
    emoji: "🎬",
    label: "Jesus Daily",
    sub: "Vidéos prophétiques",
    href: "/jesus-daily",
    gradient: "linear-gradient(145deg, #3d1a72 0%, #5a2ca0 55%, #a78bfa 100%)",
  ...
  },
  {
    ...
    emoji: "🎓",
    label: "Classes",
    sub: "Formation biblique",
    href: "/classes",
    gradient: "linear-gradient(145deg, #164e63 0%, #0891b2 55%, #22d3ee 100%)",
  ...
  },
  {
    ...
    emoji: "📋",
    label: "Plan biblique",
    sub: "Lecture quotidienne",
    href: "/plan-biblique",
    gradient: "linear-gradient(145deg, #7c2d12 0%, #c2410c 55%, #fb923c 100%)",
  ...
  },
  {
    ...
    emoji: "📡",
    label: "Live",
    sub: "Cultes en direct",
    href: "/live",
    gradient: "linear-gradient(145deg, #1e1b4b 0%, #4338ca 55%, #818cf8 100%)",
...
export default function DashboardClient({ displayName, avatarUrl, email }: Props) {
        ...
        <div className="dashboard-hero-inner">
          ...
          <div className="dashboard-hero-text">
            ...
            <p className="dashboard-verse">
              « Que ta parole soit une lampe à mes pieds » — Ps 119:105
            </p>
          </div>
          ...
          <div className="dashboard-premium-cta-left">
            ...
            <div>
              ...
              <div className="dashboard-premium-cta-desc">
                Accès illimité · Classes exclusives · Groupes privés
              </div>
            </div>
          </div>
