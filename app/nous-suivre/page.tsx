...
const PLATFORMS = [
  ...
  { name: "TikTok", handle: "@jesusdaily_ccb", url: "https://tiktok.com/@jesusdaily_ccb", emoji: "🎵", color: "#69C9D0", bg: "rgba(105,201,208,0.08)", border: "rgba(105,201,208,0.25)", desc: "Jesus Daily — paroles prophétiques de 45 secondes chaque matin", cta: "Suivre" },
    ...
    <div style={{ maxWidth: 700, margin: "0 auto", padding: "32px 16px 80px" }}>
      <div style={{ textAlign: "center", marginBottom: 40 }}>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: 15, lineHeight: 1.6, maxWidth: 480, margin: "0 auto" }}>
          Suivez le Centre Chrétien Berakah sur toutes les plateformes pour ne manquer aucun message, aucun live ni aucune ressource spirituelle.
        </p>
      </div>
