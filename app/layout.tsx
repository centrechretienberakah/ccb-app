...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        {/* Thème appliqué AVANT le 1er rendu (inline = synchrone, sans fetch)
            → aucun flash / bascule clair-sombre au rafraîchissement. */}
        <script
          suppressHydrationWarning
          dangerouslySetInnerHTML={{
            __html:
              "(function(){try{var s=localStorage.getItem('ccb-theme');var d=window.matchMedia('(prefers-color-scheme: dark)').matches;var t=s||(d?'dark':'light');document.documentElement.setAttribute('data-theme',t);document.documentElement.style.colorScheme=t;}catch(e){}})();",
          }}
        />
