...
export const DEFAULT_STATS_MD = `2010 | Année de fondation
500+ | Membres actifs
10+ | Groupes de cellule
3 | Services par semaine`;

export const DEFAULT_HISTOIRE_MD = `Le Centre Chrétien Berakah a été fondé avec la conviction que l'église locale est le plan de Dieu pour transformer les individus, les familles et les nations. **Berakah** — mot hébreu signifiant « bénédiction » — reflète notre identité : être un peuple béni pour être une bénédiction.
...
export const DEFAULT_VISION = "Notre vision est de voir des hommes et des femmes profondément enracinés dans la Parole de Dieu, transformés par le Saint-Esprit et équipés pour impacter leur génération avec l'amour, la vérité et la puissance de Jésus-Christ.";
export const DEFAULT_MISSION = "Annoncer l'Évangile de Jésus-Christ, former des disciples bibliquement solides, bâtir la communauté et envoyer des ouvriers dans la moisson.";

export const DEFAULT_VALUES_MD = `📖 | Parole de Dieu | Toute doctrine et pratique est fondée sur la Bible, Parole inspirée et infaillible de Dieu.
...
export const DEFAULT_CONFESSION_MD = `# Confession de Foi
